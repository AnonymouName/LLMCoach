...
class Monitor:
    ...
    def prepare_for_rules(self):
        ...
        self.muti_traffic_rules["rulec"] = rule_c
    ...
    def prepare_for_rulec(self):
        traffic_rule = '(\
                            always(not NPCAheadAhead<=0.1)\
            )'
        return traffic_rule
...
if __name__ == "__main__":
    ...
    input_file = 'test_cases/EXTRA-EXPERIMENTS/T-Junction04.txt'

    isGroundTruth = True
    extracted_script = ExtractAll(input_file,isGroundTruth)
    scenario_spec = extracted_script.Get_Specifications()
    output_file = '/data/DATA-For-Traffic-Laws/coverage/Intersection_with_Double-Direction_Roads/data/result20-11-2021-10-34-05.json'
